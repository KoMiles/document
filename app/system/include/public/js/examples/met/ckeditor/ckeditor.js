define("examples/met/ckeditor/ckeditor", [basepath+'ckeditor/ckeditor.js'],
function(require, exports, module) {
	...
	function ckeditor(name,type,x,y) {
		...
		if(p.prev("dt").length<1)p.css({'padding':'0px','margin':'0px 0px 10px'});
