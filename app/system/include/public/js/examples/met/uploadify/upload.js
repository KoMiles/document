define(function(require, exports, module) {
	...
	var common = require('common');
		require('examples/met/uploadify/jquery.uploadify.v2.1.4.min');
	
	/*语言文字*/
	var text1 = common.langtxt('jsx15');
	var text2 = common.langtxt('js35');
	var text3 = common.langtxt('jsx17');
	...
	function upload(d) { //上传
		...
		/*
		if(lval)url+= '&is_thumblist=1';
		if(cval)url+= '&is_thumbcontent=1';
		if(w){
			url+= '&thumblist_width='+w;
			url+= '&thumbcontent_width='+w;
		}
		if(h){
			url+= '&thumblist_height='+h;
			url+= '&thumbcontent_height='+h;
		}
		*/
